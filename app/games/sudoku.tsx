...
export type SudokuScreenContentProps = {
  embedded?: boolean;
  onBack?: () => void;
};

/** 게임 → 스도쿠 */
export function SudokuContent({ embedded = false, onBack }: SudokuScreenContentProps) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={[]}>
      {onBack ? <WideSubpaneHeader title={t('gameSudokuTitle')} onBack={onBack} /> : null}
      <View
        style={[
          styles.fill,
          {
        ...
        <View style={styles.inner}>
          <SudokuGame wide={wide} split={split} fill viewportHeight={height} />
        </View>
      </View>
    </SafeAreaView>
  );
