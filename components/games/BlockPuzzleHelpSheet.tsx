...
/** 블록 퍼즐 플레이 방법 — slide-up 바텀 시트 */
export function BlockPuzzleHelpSheet({ visible, onClose }: Props) {
      ...
      <View style={styles.backdrop}>
        ...
        <View style={[styles.sheet, { paddingBottom: Math.max(insets.bottom, 16) + 12 }]}>
          ...
          <ScrollView
            ...
            <Text style={styles.kicker}>{t('gameBlockPuzzleKicker')}</Text>
            <Text style={styles.blurb}>{t('gameBlockPuzzleBlurb')}</Text>
          </ScrollView>
        </View>
      </View>
    </Modal>
