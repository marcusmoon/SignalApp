...
/** 스도쿠 플레이 방법 — slide-up 바텀 시트 */
export function SudokuHelpSheet({ visible, onClose }: Props) {
      ...
      <View style={styles.backdrop}>
        ...
        <View style={[styles.sheet, { paddingBottom: Math.max(insets.bottom, 16) + 12 }]}>
          ...
          <ScrollView
            ...
            <Text style={styles.kicker}>{t('gameSudokuKicker')}</Text>
            <Text style={styles.blurb}>{t('gameSudokuBlurb')}</Text>
          </ScrollView>
        </View>
      </View>
    </Modal>
