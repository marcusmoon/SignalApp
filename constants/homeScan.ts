...
export const HOME_AGENDA_TIME_PX = 12;
export const HOME_AGENDA_TIME_LINE_PX = 16;
export const HOME_AGENDA_CHIP_PX = 10;

export const HOME_NEWS_TITLE_PX = FEED_ARTICLE_TITLE_PX;
export const HOME_NEWS_TITLE_LINE_PX = FEED_ARTICLE_TITLE_LINE_PX;
export const HOME_NEWS_ROW_PAD_V = 8;
export const HOME_NEWS_META_PX = 11;

export const HOME_KEYWORD_CHIP_PX = 11;
export const HOME_KEYWORD_CHIP_LINE_PX = 15;
export const HOME_KEYWORD_CHIP_LOGO = 18;
export const HOME_KEYWORD_CHIP_MAX_WIDTH = 148;

export const HOME_QUOTE_NAME_PX = 14;
export const HOME_QUOTE_PRICE_PX = 14;
export const HOME_QUOTE_CHANGE_PX = 16;
export const HOME_QUOTE_LOGO = 22;
export const HOME_QUOTE_TILE_MIN_HEIGHT = 56;

export const HOME_SHORTCUT_LABEL_PX = 11;
export const HOME_SHORTCUT_ICON = 17;

export const HOME_CARD_PAD_H = 12;
export const HOME_ETF_TITLE_PX = 15;
export const HOME_ETF_TITLE_LINE_PX = 21;
