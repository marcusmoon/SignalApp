...
| 알림함 | ✅ | ✅ | ✅ | — 단일 | — | |
| 유튜브 | ✅ | ✅ | — | — | — | |
| 시세 | ✅ | ✅ | — | — | — | iPhone refresh FAB · 관심은 `+`와 스택 · 세그먼트↔리스트 사이 `지연 · …` 칩 |
| 게시판 | ✅ | ✅ | — | — | — | source 필터 |
