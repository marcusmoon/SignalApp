...
export const en = {
  ...
  newsDigestViewModeLive: 'Live',
  newsDigestFeedPendingHeader: 'Not summarized yet',
  newsDigestFeedPendingMore: '{{count}} more',
  newsDigestFeedLiveMeta: 'Latest articles not yet grouped into digests.',
