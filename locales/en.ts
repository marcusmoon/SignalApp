...
export const en = {
  focusNewsTitle: 'Changes to follow',
  focusNewsTab: 'Following',
  focusNewsPeriod: '7 days through selected date · Newest first',
  focusNewsEmpty: 'No related issues found in these 7 days.',
  focusNewsMore: 'More updates',
  newsRevisionCorrection: 'Correction',
  newsRevisionUpdate: 'What changed',
  newsRevisionFacts: 'Key facts',
  newsPreviousUpdates: 'Earlier updates',
  newsHistoryRetry: 'Retry earlier updates',
  newsSave: 'Save on this device',
  newsUnsave: 'Remove saved issue',
  newsSaveFailed: 'Could not save.',
  newsSaved: 'Saved',
  newsSavedEmpty: 'No issues saved on this device.',
  companyTimeline: 'Recent developments',
  companyTimelineRetry: 'Some updates could not load. Retry',
  companyUpcomingEarnings: 'Upcoming earnings',
  companyBriefing: 'Market briefing',
  homeNewsAll: 'All',
  homeNewsWatch: 'Watchlist',
  homeNewsRead: 'Read',
  homeNewsUnavailable: 'Could not load this information.',
  homeNewsNoWatchlist: 'Your watchlist is empty.',
  homeNewsNoMatch: 'No watchlist stories for this date.',
  homeNewsManageWatchlist: 'Manage watchlist',
  homePartialLoadError: '{{sections}} could not update. Previously loaded information is kept.',
  homeReadBriefing: 'Full briefing',
  commonBack: 'Back',
  commonCancel: 'Cancel',
  ...
  homeSignalOpenFull: 'Open market',
  ...
  digestCopyText: 'Copy',
  digestCopyTextA11y: 'Copy title and summary',
  digestCopyDone: 'Copied',
  digestCopyFailed: 'Couldn’t copy.',
  ...
  communitySourceNaverYamizal: '미치다',
  communitySourceMotleyFool: 'Motley Fool',
  ...
  settingsHomeDisplaySection: 'Home counts',
  settingsHomeDisplayHint:
    'Adjust how many watchlist, sectors, and news items appear on home. Hero and calendar chips are automatic.',
  settingsHomeNewsFlowDisplaySection: 'News',
  settingsHomeNewsFlowDisplayHint: 'Choose how many news items to show on home.',
  settingsHomeNewsFlowDisplayValue: 'Show {{count}}',
  settingsHomeWatchlistDisplaySection: 'Watchlist',
  settingsHomeWatchlistDisplayHint: 'Choose how many watchlist items to show on home (today only).',
  settingsHomeWatchlistDisplayValue: 'Show {{count}}',
  settingsHomeSectorFlowDisplaySection: 'Sectors',
  settingsHomeSectorFlowDisplayHint: 'Choose how many heatmap cells to show in home sectors.',
  settingsHomeSectorFlowDisplayValue: 'Show {{count}}',
  settingsHomeShortcutsSection: 'Home shortcuts',
  settingsHomeShortcutsHint:
    'Pick multiple board, quotes, or news targets and reorder them. Up to {{count}}.',
  settingsHomeShortcutsMaxHint: 'You can select up to {{count}} shortcuts.',
  settingsHomeShortcutsOrderSection: 'Order',
  settingsHomeShortcutsOrderHint: 'Long-press to reorder.',
  settingsHomeShortcutsEmpty: 'No shortcuts selected.',
  settingsHomeShortcutsAddSection: 'Add shortcuts',
  settingsHomeShortcutsAddHint: 'You can enable several targets under the same parent.',
  settingsHomeShortcutGroupOther: 'Other',
  settingsHomeShortcutRemove: 'Remove shortcut',
  settingsHomeShortcutDragHandleA11y: 'Reorder {{name}}',
  ...
  homeTileNewsCrypto: 'Coin',
  homeTileNewsIt: 'IT',
  homeTileNewsVideo: 'YT',
  homeTileBoardNaver: '미주미',
  homeTileBoardYamizal: '미치다',
  homeTileBoardMotleyFool: 'Motley Fool',
  ...
  screenSignal: 'Market',
  ipadHomeTitle: 'Recap',
  ipadHomeTodayBriefingSubtitle: 'News, market & quotes summary',
  ipadHomeIssuesSubtitle: 'Time-ordered key news',
  ipadHomeIssuesEmpty: 'No news to show.',
  ...
  ipadHomeHeroEmpty: 'No briefing for this date.',
  todayBriefingDisclosureDigestTitle: 'Filings',
  todayBriefingDisclosureDigestSubtitle: "Today's notable filings",
  todayBriefingDisclosureDigestEmpty: 'No filings to show today.',
  todayBriefingReadMore: 'Read full briefing',
  todayBriefingKeyPoints: 'Key points',
  todayBriefingSources: 'Sources',
  todayBriefingLoadError: "Couldn't load the recap.",
  todayBriefingEmpty: 'No recap for this date.',
  todayBriefingDetailKicker: 'Recap',
  ipadHomeLoadError: 'Could not load home summary.',
  homeFocusSourceCount: '{{count}} sources',
  homeFocusWatchTitle: 'Quotes',
  homeFocusBoardSubtitle: 'LikeUSStock · 미치다 · Motley Fool',
  homeFocusBoardEmpty: 'No recent posts',
  homeFocusSignalEmpty: 'No sessions to show.',
  screenGameCenter: 'Games',
  gameCenterLead: 'Short number puzzles to reset your focus.',
  gameHubResumeBadge: 'Resume',
  gameHubResume: 'Saved progress available',
  gameHubResumeLevel: 'Resume · level {{level}}',
  gameHubBestLevel: 'Best level {{level}}',
  gameHubBestTime: 'Best {{time}}',
  gameHubBestScore: 'Best {{score}}',
  gameHubResumeScore: 'Resume · {{score}} pts',
  gameHubClears: '{{count}} clears',
  gameHubNoRecordsYet: 'No records yet',
  gameRecordsTitle: 'Game records',
  gameRecordsRuns: 'Runs started',
  gameRecordsLevelsCleared: 'Levels cleared',
  gameRecordsBestLevel: 'Best level',
  gameRecordsBestScore: 'Best score',
  gameRecordsClears: 'Clears',
  gameRecordsBestTime: 'Best time',
  gameRecordsBestMistakes: 'Fewest mistakes',
  gameRecordsEmpty: '—',
  gameRecordsFootnote: 'Progress and records stay on this device only.',
  ...
  gameSumTrailLevel: 'Level',
  gameSumTrailTarget: 'Target',
  gameSumTrailScore: 'Score',
  gameSumTrailClears: 'Clears {{clears}}/{{needed}}',
  gameSumTrailPathSum: 'Path sum {{sum}}',
  gameSumTrailUndo: 'Undo',
  gameSumTrailClearPath: 'Clear path',
  gameSumTrailRestart: 'Restart',
  gameSumTrailCleared: 'Level cleared!',
  gameSumTrailClearedBody: 'Move on and try longer trails.',
  gameSumTrailNextLevel: 'Next level',
  ...
  gameSumTrailHint: 'Hint {{count}}',
  gameSumTrailHintA11y: 'Use hint, {{count}} remaining',
  gameSumTrailHintCellA11y: 'Hint cell, number {{value}}',
  gameSumTrailFailed: 'Failed!',
  gameSumTrailFailedBody: 'You went over the target or ran out of moves. Try again.',
  gameSudokuTitle: 'Sudoku',
  gameSudokuCardBody: 'Fill the 9×9 grid so every row, column, and box has 1–9',
  gameSudokuKicker: 'Place 1–9 in every row, column, and box',
  gameSudokuBlurb:
    'Select a cell, then enter a digit. Numbers cannot repeat in the same row, column, or 3×3 box. Hints fill one correct cell.',
  gameSudokuHowTo: 'How to play',
  gameSudokuHelpShowA11y: 'Show how to play',
  gameSudokuDiffEasy: 'Easy',
  gameSudokuDiffNormal: 'Normal',
  gameSudokuDiffHard: 'Hard',
  gameSudokuMistakes: 'Mistakes',
  gameSudokuTime: 'Time',
  gameSudokuHints: 'Hints',
  gameSudokuProgress: 'Filled',
  ...
  gameSudokuCellEmptyA11y: 'Row {{row}}, column {{col}}, empty',
  gameSudokuCleared: 'Complete!',
  gameSudokuClearedBody: 'You filled the board. Try a new puzzle.',
  gameBlockPuzzleTitle: 'Block Puzzle',
  ...
  gameBlockPuzzleDiffNormal: 'Normal',
  gameBlockPuzzleDiffHard: 'Hard',
  gameBlockPuzzleScore: 'Score',
  gameBlockPuzzleLines: 'Lines',
  gameBlockPuzzleLevel: 'Level',
  gameBlockPuzzleNext: 'Next',
  gameBlockPuzzleNewGame: 'New game',
  gameBlockPuzzleLineFx: 'Line clear!',
  gameBlockPuzzleLinePoints: '+{{points}}',
  gameBlockPuzzleGameOver: 'Game over',
  gameBlockPuzzleGameOverScore: 'Score {{score}}',
  gameBlockPuzzleMoveLeftA11y: 'Move left',
  gameBlockPuzzleMoveRightA11y: 'Move right',
  gameBlockPuzzleRotateA11y: 'Rotate',
  gameBlockPuzzleSoftDropA11y: 'Soft drop',
  gameBlockPuzzleHardDropA11y: 'Hard drop',
  gameRecordsBestLines: 'Most lines',
  homeEtfInsightTitle: 'Sectors',
  homeEtfInsightEmpty: 'No sectors for this date.',
  etfInsightDetailKicker: 'Sectors',
  etfInsightKeyPoints: 'Key points',
  etfInsightThemes: 'Themes',
  etfInsightFlows: 'Flow',
  etfInsightFlowInflow: 'Inflow',
  etfInsightFlowOutflow: 'Outflow',
  etfInsightFlowOpenSource: 'Source',
  etfInsightHeatmap: 'Heatmap',
  etfInsightRotation: 'Rotation',
  etfInsightSources: 'Sources',
  etfInsightPeriodLabel: '{{period}}',
  etfInsightLoadError: 'Could not load sectors.',
  etfInsightEmpty: 'No sectors to show.',
  etfInsightListEmpty: 'No sectors yet.',
  newsIssuesTitle: 'News',
  newsIssuesCategoryAll: 'All',
  newsIssuesEmpty: 'No news for this date.',
  newsIssuesLoadError: 'Could not load news.',
  newsDigestEmpty: 'No news to show.',
  disclosureFlowTitle: 'Filing Flow',
  disclosureFlowSubtitle: 'Key filings by date',
  disclosureFlowEmpty: 'No filing flow for this date.',
  disclosureFlowLoadError: 'Could not load filing flow.',
  disclosureDigestEmpty: 'No filing flow to show.',
  ...
  disclosuresImportantBadge: 'Material',
  ...
  disclosuresDetailTitle: 'Filing detail',
  ...
  disclosuresEmptyType: 'No disclosures match this type.',
  disclosuresTypeOther: 'Other',
  disclosuresTypeDartA: 'Periodic',
  disclosuresTypeDartB: 'Material',
  disclosuresTypeDartC: 'Issuance',
  disclosuresTypeDartD: 'Ownership',
  disclosuresTypeDartE: 'Other KR',
  disclosuresTypeDartI: 'Exchange',
  disclosuresTypeSec8K: 'Material',
  disclosuresTypeSec10Q: 'Quarterly',
  disclosuresTypeSec10K: 'Annual',
  disclosuresTypeSec6K: 'Foreign material',
  disclosuresTypeSec20F: 'Foreign annual',
  disclosuresTypeSecS1: 'Registration',
  ...
  calendarScopeMeaningful: 'Key',
  calendarScopeFull: 'All macro',
  calendarSectionPolicy: 'Policy',
  calendarSectionMacro: 'Key data',
  calendarSectionEarnings: 'Watchlist',
  calendarSectionHoliday: 'Holidays',
  calendarScreenEmptyDayMeaningful: 'No key events on this date.',
  calendarFilterEmptyMeaningful: 'No key events this month.',
  ...
  accountSocialLinkMenuTitle: 'Social accounts',
  ...
  accountActivityAlerts: 'Notifications',
  ...
  accountSocialKakaoClientSecret:
    'Web Kakao login exchanges the code on the server. Copy the Client secret from Kakao Developers → Platform keys → REST API key into Signal Admin → Social login → Kakao Client secret, then save. (Enabled by default on Kakao; separate from native iOS login.)',
  accountSocialKakaoRedirectMismatch:
    'The Redirect URI used for authorization and token exchange do not match. Register the same URL (e.g. https://<domain>/web/oauth) under Kakao REST API key → Redirect URI.',
  ...
  quickSettingsDisplayLink: 'More settings',
  ...
  settingsFeedContentWeightHint:
    'Applies to home (hero, watchlist, news flow), news and quotes rows, and YouTube cards.',
  ...
  settingsBriefingPushEnabledHint: 'Get alerts and push for recap, news, and session updates.',
  ...
  alertsFilterSignal: 'Signal',
  alertsFilterSystem: 'Notices',
  alertsTypeTodayBriefing: 'Recap',
  alertsTypeMarketBriefing: 'Sessions',
  alertsTypeNewsDigest: 'News',
  alertsTypeDisclosureDigest: 'Filing flow',
  alertsTypeMarketAlert: 'Market alert',
  alertsTypeEarnings: 'Earnings',
  alertsTypeAppUpdate: 'Update',
  alertsTypeServiceNotice: 'Notice',
  alertsTypeAccount: 'Account',
  alertsTypeTest: 'Test',
  alertsTypeOther: 'Alert',
  alertsOpenSettings: 'Notification settings',
  alertsSwipeDelete: 'Delete',
  alertsSwipeDeleteA11y: 'Delete {{title}}',
  alertsDeleteAll: 'Clear all',
  alertsDeleteAllA11y: 'Clear all alerts',
  ...
  feedDigestTailGoToNewsFlowA11y: 'Go to news',
  feedDigestTailGoToDisclosureFlowA11y: 'Go to filing flow',
  ...
  newsTitleShowOriginal: 'Show original title',
  newsTitleShowTranslation: 'Show translation',
  newsTitleShowLocalized: 'Show translated title',
  newsTitleListShowOriginal: 'Show all original titles',
  newsTitleListShowTranslation: 'Show all translated titles',
  newsTitleListShowLocalized: 'Show all translated titles',
  ...
  symbolDetailSectionNews: 'News',
  symbolDetailSectionTodaySignal: 'Signal evidence',
  symbolDetailSectionDisclosures: 'Filings',
  symbolDetailNoDisclosures: 'No recent filings.',
  symbolDetailDisclosuresAll: 'View all filings',
  symbolDetailLinksTitle: 'Quick links',
  symbolDetailLinkEarnings: 'Earnings',
  symbolDetailLinkSec: 'SEC',
  symbolDetailLinkGoogleFinance: 'Google',
  symbolDetailLinkTradingView: 'TradingView',
  symbolDetailLinkNaverNews: 'Naver news',
  symbolDetailLinkDart: 'Naver filings',
  ...
  symbolDetailNoNews: 'No news found.',
  ...
  briefingHubMarketEmptyBody: 'Try another market, or check back soon.',
  ...
  briefingSessionEmptyBody: 'Try another session, or check back soon.',
  ...
  briefingSessionHintClose: 'Close summary · next session checkpoints',
  briefingDetailOverview: 'Overview',
  briefingDetailSectors: 'Sectors',
