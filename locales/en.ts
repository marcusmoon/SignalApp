...
export const en = {
  ...
  settingsHomeDisplayHint:
    'Adjust how many watchlist, sector flow, and news flow items appear on home. Hero and calendar chips are automatic.',
  settingsHomeNewsFlowDisplaySection: 'News Flow',
  settingsHomeNewsFlowDisplayHint: 'Choose how many news flow items to show at the bottom of home.',
  ...
  settingsHomeSectorFlowDisplaySection: 'Sector Flow',
  settingsHomeSectorFlowDisplayHint: 'Choose how many heatmap cells to show in home sector flow.',
  ...
  ipadHomeSignalTitle: 'Session Briefing',
  ...
  todayBriefingLoadError: "Couldn't load today's wrap.",
  todayBriefingEmpty: "No today's wrap for this date.",
  ...
  gameHubResumeMahjong: 'Resume · {{count}} tiles left',
  ...
  gameBlockPuzzleBlurb:
    'Move, rotate, and drop blocks into place. Full rows disappear for points. Speed increases every 10 lines. The game ends when the stack reaches the top.',
  ...
  gameMahjongTitle: 'Mahjong Solitaire',
  gameMahjongCardBody: 'Match identical free tiles and clear the layered board',
  gameMahjongKicker: 'Pair up matching tiles',
  gameMahjongBlurb:
    'Only tiles with no tile above and at least one open side can be selected. Clear every tile to win. If no pairs remain, the board is stuck.',
  gameMahjongHowTo: 'How to play',
  gameMahjongHelpShowA11y: 'Show how to play',
  gameMahjongDiffEasy: 'Easy',
  gameMahjongDiffNormal: 'Normal',
  gameMahjongDiffHard: 'Hard',
  gameMahjongScore: 'Score',
  gameMahjongRemaining: 'Tiles left',
  gameMahjongTime: 'Time',
  gameMahjongHint: 'Hint {{count}}',
  gameMahjongUndo: 'Undo',
  gameMahjongNewGame: 'New game',
  gameMahjongMatchFx: 'Match!',
  gameMahjongCleared: 'Cleared!',
  gameMahjongClearedScore: 'Score {{score}}',
  gameMahjongStuck: 'Stuck',
  gameMahjongStuckBody: 'No more pairs. Start a new game.',
  ...
  etfInsightLoadError: 'Could not load sector flow.',
  etfInsightEmpty: 'No sector flow to show.',
  etfInsightListEmpty: 'No sector flow yet.',
  ...
  newsDigestEmpty: 'No news flow to show.',
  ...
  settingsBriefingPushEnabledHint: "Get alerts and push for today's wrap, news, and session briefings.",
  ...
  alertsTypeTodayBriefing: "Today's Wrap",
  alertsTypeMarketBriefing: 'Session briefing',
  ...
  feedDigestTailGoToNewsFlowA11y: 'Go to news flow',
