...
export const en = {
  ...
  settingsAppIconHint: 'Choose the SIGNAL brand icon color used inside the app.',
  settingsAppIconNativeNote: 'Home-screen icon switching can use this saved choice after native icon sets are wired.',
