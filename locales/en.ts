...
export const en = {
  ...
  ipadHomeCalendarTitle: 'Invest calendar',
  ...
  etfInsightLoadError: 'Could not load ETF briefing.',
  etfInsightEmpty: 'No ETF briefing to show.',
  etfInsightListEmpty: 'No ETF briefings yet.',
