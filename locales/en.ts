...
export const en = {
  ...
  settingsHomeBoardDisplayHint: 'Recent posts per community source on the home board section.',
  settingsHomeBoardDisplayValue: '{{count}} per source',
  ...
  disclosuresFocusAll: 'All',
  disclosuresFocusImportant: 'Material',
  disclosuresImportantBadge: 'Material',
  disclosuresEmpty: 'No disclosures to show.',
  disclosuresEmptyImportant: 'No material disclosures.',
