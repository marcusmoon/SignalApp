...
export const en = {
  ...
  settingsHomeNewsFlowDisplayHint: 'Choose how many news items to show on the home screen.',
  ...
  settingsHomeBoardDisplaySection: 'Board',
  settingsHomeBoardDisplayHint: 'Recent posts per board on the home board section.',
  settingsHomeBoardDisplaySourceValue: '{{board}}: {{count}}',
  settingsHomeMarketBriefingDisplaySection: 'Market briefing',
  settingsHomeMarketBriefingDisplayHint: 'Choose how many recent market briefing sessions to show on home.',
  settingsHomeMarketBriefingDisplayValue: 'Show {{count}}',
