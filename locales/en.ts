...
export const en = {
  ...
  quantSubtitle: 'Scores your watchlist by price momentum and quote freshness.',
  quantEmpty: 'No watchlist quotes are ready to score yet.',
  quantError: 'Could not load quant scores.',
  quantScore: 'Score',
  quantRiskLow: 'Low volatility',
  quantRiskMedium: 'Medium volatility',
  quantRiskHigh: 'High volatility',
  quantFactorMomentum: 'Momentum',
  quantFactorRegular: 'Regular',
  quantFactorFreshness: 'Freshness',
  quantReasonAfterHoursUp: 'After-hours reference up',
  quantReasonAfterHoursDown: 'After-hours reference down',
  quantReasonRegularUp: 'Regular session up',
  quantReasonRegularDown: 'Regular session down',
  quantReasonAfterHoursSource: 'Derivative reference',
  quantReasonFreshQuote: 'Fresh quote',
  quantReasonStaleQuote: 'Needs quote check',
  quantReasonPriceStable: 'Price stable',
