...
export const en = {
  ...
  accountSocialTitle: 'Social sign-in coming',
  ...
  accountTermsText: 'I agree to SIGNAL’s basic terms and privacy notice. Market information is for reference only, and investment decisions remain my responsibility.',
  accountTermsRequired: 'Accept the basic terms to create an account.',
  ...
  settingsSignalAlertsEnabled: "Today's signal candidates",
  settingsSignalAlertsHint: 'Preview push candidates created by the Insight Job in the alerts screen.',
  settingsSignalWatchlistOnly: 'Watchlist signals only',
  settingsSignalWatchlistOnlyHint: 'Show only signal candidates connected to your watchlist symbols.',
  ...
  alertsLoginRequiredButton: 'Go to account',
