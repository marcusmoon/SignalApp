...
export const en = {
  ...
  settingsHomeDisplaySection: 'Home',
  settingsHomeDisplayHint:
    'Adjust home shortcuts, watchlist, sector flow, and news flow. Hero and calendar chips are automatic.',
  ...
  settingsHomeShortcutsSection: 'Shortcuts',
  settingsHomeShortcutsHint: 'Choose mid-home shortcuts. Up to {{count}}.',
