...
export const en = {
  ...
  tabCalls: 'Calls',
  tabMore: 'More',
  homeEyebrow: 'Market briefing',
  homeMoodActive: 'There are signals to check now',
  homeMoodWatch: 'Check the largest moves in your watchlist',
  homeMoodQuiet: 'Check only the key flow today',
  homePulseHeadline: '{{movers}} of {{count}} watchlist names are moving',
  homePulseQuiet: 'No major watchlist move yet',
  homeFocusKicker: 'Signal to watch now',
  homeBriefingKicker: 'Latest market brief',
  homeFocusFallbackTitle: 'Signal is organizing the market flow',
  homeFocusFallbackBody: 'When watchlist and news data are ready, the most relevant signal appears here first.',
  homeFocusOpenSignals: 'View all signals',
  homeFocusOpenBriefing: 'Market briefing',
  homeOverviewSignals: 'Signals',
  homeOverviewBriefings: 'Briefs',
  homeOverviewWatch: 'Watchlist',
  homeOverviewRelated: 'Related news',
  homeNextSignals: 'Next signals',
  homePillSignals: '{{count}} signals',
  homePillWatchlist: '{{count}} watch',
  homePillEvidence: '{{count}} related',
  homeTodaySection: 'Key signals',
  homeWatchSection: 'Watchlist',
  homeEvidenceSection: 'Related material',
  homeRelatedSection: 'Related news',
  homeQuantSection: 'Investment views',
  homeSeeAll: 'All',
  homeOpenSignals: 'View signals',
  homeOpenQuotes: 'Quotes',
  homeOpenQuotesFull: 'View quotes',
  homeOpenNews: 'News',
  homeOpenNewsFull: 'View news',
  homeWatchReason: 'Watchlist',
  homeWatchNewsCount: '{{count}} related news',
  homeWatchReasonPriceSurge: 'Surging',
  homeWatchReasonPriceDrop: 'Dropping',
  homeWatchReasonPriceMove: 'Price move',
  homeWatchReasonNewsDense: 'News cluster',
  homeWatchReasonNewsActive: 'News rising',
  homeWatchReasonInsightAlert: 'Key signal',
  homeWatchReasonInsightWatch: 'Signal detected',
  homeWatchReasonVideoActive: 'Video rising',
  homeWatchReasonEarningsSoon: 'Earnings soon',
  homeWatchReasonEventSoon: 'Event soon',
  homeWatchReasonQuiet: 'Watching',
  homeEmptySignals: 'No signals to show yet.',
  homeEmptyWatchlist: 'Add watchlist symbols to check them here first.',
  homeEvidenceFallback: 'No related content.',
  homeEvidenceNewsFallback: 'No news to show.',
  homeEvidenceYoutubeFallback: 'No videos to show.',
  homeBriefingAction: 'Open market briefing',
  ...
  quantSubtitle: 'Reviews major KOSPI names through price action, volume, heat and risk. This is not a buy recommendation; it explains why to watch and what to check.',
  quantEmpty: 'No price data is ready for review yet.',
  quantError: 'Could not load investment views.',
  quantRankBadge: 'KOSPI #{{rank}}',
  quantScore: 'Check',
  quantConfidence: 'Confidence',
  quant20dReturn: '20d',
  quantRiskLow: 'Low volatility',
  quantRiskMedium: 'Medium volatility',
  quantRiskHigh: 'High volatility',
  quantRiskUnknown: 'Volatility n/a',
  quantActionBuy: 'Watch',
  quantActionAccumulate: 'Build watch',
  quantActionHold: 'Wait for proof',
  quantActionReduce: 'Manage risk',
  quantActionAvoid: 'Hold off',
  quantFactorTrend: 'Trend',
  quantFactorMomentum: 'Momentum',
  quantFactorMeanReversion: 'Reversion',
  quantFactorVolume: 'Volume',
  quantIndicatorRsi: 'RSI',
  quantIndicatorSma20: 'vs SMA20',
  quantIndicatorVol: 'Volatility',
  quantReasonTrendUp: 'Uptrend',
  quantReasonTrendDown: 'Downtrend',
  quantReasonGoldenCross: 'Bullish alignment',
  quantReasonDeadCross: 'Bearish alignment',
  quantReasonMomentumStrong: 'Strong momentum',
  quantReasonMomentumWeak: 'Weak momentum',
  quantReasonNear52wHigh: 'Near 52w high',
  quantReasonNear52wLow: 'Near 52w low',
  quantReasonOverbought: 'Overbought',
  quantReasonOverboughtMild: 'Overbought watch',
  quantReasonOversold: 'Oversold',
  quantReasonOversoldMild: 'Oversold watch',
  quantReasonVolumeSpike: 'Volume spike',
  quantReasonVolumeActive: 'Active volume',
  quantReasonVolumeDry: 'Thin volume',
  quantReasonRangeBound: 'Range-bound',
  quantPerspectiveLabel: 'View',
  quantPerspectivePrinciple: 'Decision lens',
  quantPerspectivePositive: 'Why watch',
  quantPerspectiveCaution: 'What to watch',
  quantChecklistScore: 'Checklist score',
  quantLensHealth: 'Business strength',
  quantLensTiming: 'Buy timing',
  quantLensRisk: 'Risk',
  quantLensScenario: '10y scenario',
  quantLensHealthScore: 'Strength',
  quantLensRiskScore: 'Risk',
  quantLensScenarioScore: 'Validity',
  quantLensStatusStrong: 'Strong',
  quantLensStatusWatch: 'Watch',
  quantLensStatusNeutral: 'Neutral',
  quantLensStatusWeak: 'Weak',
  quantLensStatusRiskHigh: 'Alert',
  quantLensStatusRiskWatch: 'Watch',
  quantLensStatusRiskLow: 'Stable',
  quantLensHealthBulletTrend: 'Trend strength is {{value}}.',
  quantLensHealthBulletMomentum: 'Momentum score is {{value}}.',
  quantLensHealthBulletConfidence: 'Data confidence is {{value}}.',
  quantLensTimingPullback: 'Pullback zone at {{value}} vs SMA20.',
  quantLensTimingTrend: 'Current position is {{value}} vs SMA20.',
  quantLensTimingBulletMomentum: '20-day return is {{value}}.',
  quantLensRiskBulletVolatility: 'Volatility is {{value}}.',
  quantLensRiskBulletRsi: 'RSI is {{value}}.',
  quantLensScenarioBulletThesis: 'Long-term validity depends on trend durability and risk control.',
  quantLensScenarioBulletTrend: 'Long-term trend score is {{value}}.',
  quantLensScenarioBulletCheckpoint: 'Next checkpoint is trend damage or volatility expansion.',
  quantLensDataBars: 'Data',
  ...
  accountActivityBriefing: 'Market briefing',
  accountActivityBriefingDesc: 'Review automated Korea and US market briefs.',
  feedBriefingCtaTitle: 'Market briefing',
  ...
  a11yBriefing: 'Open market briefing',
  ...
  alertsCandidateTitle: "Today's alert candidates",
  alertsCandidateHint: 'Pre-push preview of signal candidates generated by the server today.',
  alertsCandidateOpenAll: 'See all',
  ...
  symbolDetailQuantSection: 'Investment view',
  ...
  briefingMarketBriefingsTitle: 'Market briefings',
  briefingHubEyebrow: 'Signal Market Brief',
  briefingHubTitle: 'Start with the market brief',
  briefingHubSubtitle: 'Read Korea three times a day and the US overnight brief in one place.',
  briefingHubWaitingBadge: 'Waiting',
  briefingHubOpenDetail: 'Open full brief',
  briefingHubOpenBrief: 'Open',
  ...
  briefingHubTimelineTitle: 'Briefing timeline',
  briefingHubTimelineEmpty: 'No earlier session yet.',
  briefingHubTimelineWaiting: 'Generated sessions will stack up here.',
  briefingHubWatchKicker: 'My Watch',
  briefingHubWatchTitle: 'Watchlist check',
  briefingMarketKr: 'Korea',
  briefingMarketUs: 'US',
  briefingSessionMorning: 'Morning',
  briefingSessionLunch: 'Lunch',
  briefingSessionEvening: 'Evening',
  briefingSessionOvernight: 'Overnight',
  ...
  briefingOpenTodaySignal: 'Open today’s signals',
  ...
  briefingFocusTitle: "Today's checkpoints",
  briefingFocusSignal: 'Priority',
  briefingFocusSignalHeadline: '{{symbol}} · {{score}} pts',
  briefingFocusMover: 'Move',
  briefingFocusMoverHeadline: '{{symbol}} {{move}}',
  briefingFocusMoverMeta: 'Largest watchlist move',
  briefingFocusEarnings: 'Earnings',
  briefingFocusEarningsHeadline: '{{symbol}} {{date}}',
  briefingFocusMacro: 'Calendar',
  ...
  briefingRowNewsCount: '{{count}} recent headlines',
  ...
  briefingScheduleSectionTitle: 'This week’s schedule',
  briefingScheduleTabAll: 'All',
  briefingScheduleTabEarnings: 'Earnings',
  briefingScheduleTabMacro: 'Economy',
  briefingScheduleKindEarning: 'Earnings',
  briefingScheduleKindMacro: 'Macro',
  briefingScheduleMergedEmpty: 'No events to show.',
  briefingMarketTabTape: 'Indices',
  briefingMarketTabMacro: 'Macro',
