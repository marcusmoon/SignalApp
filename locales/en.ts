...
export const en = {
  ...
  settingsHomeDisplayHint:
    'Adjust how many watchlist, sector flow, and news items appear on home. Hero and calendar are automatic.',
  settingsHomeNewsFlowDisplaySection: 'News',
  settingsHomeNewsFlowDisplayHint: 'Choose how many news items to show at the bottom of home.',
  ...
  accountHubDisplaySettingsDesc: 'Adjust theme, font size, and home watchlist/news counts.',
  ...
  settingsFeedContentWeightHint:
    'Applies to home (hero, watchlist, news), news and quotes rows, and YouTube cards.',
