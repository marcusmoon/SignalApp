...
export const en = {
  ...
  screenSignal: 'Market',
  ipadHomeTitle: 'Closing Briefing',
  ipadHomeTodayBriefingSubtitle: 'News, market & quotes summary',
  ipadHomeIssuesSubtitle: 'Time-ordered key news flow',
  ipadHomeIssuesEmpty: 'No news flow to show.',
  ipadHomeSignalTitle: 'Market Briefing',
  ipadHomeSignalSubtitle: 'Four daily session updates',
  ipadHomeCalendarTitle: 'Invest schedule',
  ...
  todayBriefingLoadError: "Couldn't load the closing briefing.",
  todayBriefingEmpty: 'No closing briefing for this date.',
  todayBriefingDetailKicker: 'Closing Briefing',
  ...
  homeEtfInsightTitle: 'ETF Insights',
  homeEtfInsightEmpty: 'No ETF insight for this date.',
  etfInsightDetailKicker: 'ETF Insights',
  etfInsightKeyPoints: 'Key points',
  etfInsightThemes: 'Themes',
  etfInsightFlows: 'Flow highlights',
  etfInsightFlowInflow: 'Inflow',
  etfInsightFlowOutflow: 'Outflow',
  etfInsightFlowOpenSource: 'Open source',
  etfInsightHeatmap: 'Heatmap',
  etfInsightRotation: 'Rotation',
  etfInsightSources: 'Sources',
  etfInsightPeriodLabel: '{{period}}',
  etfInsightLoadError: 'Could not load ETF insights.',
  etfInsightEmpty: 'No ETF insight to show.',
  etfInsightListEmpty: 'No ETF insights yet.',
  ...
  settingsBriefingPushEnabledHint: 'Get alerts and push for closing briefings, news flow, and market briefings.',
  ...
  alertsTypeTodayBriefing: 'Closing Briefing',
