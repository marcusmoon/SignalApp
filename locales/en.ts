...
export const en = {
  ...
  newsDigestViewModeDigest: 'Digests',
  newsDigestViewModeLive: 'Latest',
  newsDigestFeedRecentSectionTitle: 'Latest articles',
  newsDigestFeedRecentSectionHint: 'May not appear in the digest list below yet.',
  newsDigestFeedDigestSectionTitle: 'Issue digests',
  newsDigestFeedDigestSectionHint: 'Last {{hours}} hours',
  newsDigestFeedShowAllRecent: 'View all',
  newsDigestFeedLiveSectionHint: 'Articles not shown in the digest list.',
  newsDigestFeedRealtimeEmpty: 'No latest articles to show.',
