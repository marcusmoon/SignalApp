...
export const en = {
  ...
  ipadHomeSignalSubtitle: 'Four daily market updates',
  ...
  todayBriefingLoadError: "Couldn't load the market wrap.",
  todayBriefingEmpty: 'No market wrap for this date.',
  todayBriefingDetailKicker: 'Market Wrap',
