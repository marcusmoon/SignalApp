...
export const en = {
  ...
  settingsHomeBoardPostsSection: 'Board posts',
  settingsHomeBoardPostsHint: 'Pin specific board posts as home shortcuts.',
  settingsHomeBoardPostAdd: 'Add post',
  settingsHomeBoardPostRemove: 'Remove post shortcut',
  homeShortcutsTitle: 'Shortcuts',
  homeShortcutNewsIt: 'IT news',
  homeShortcutBoardPost: 'Post',
  homeShortcutPickBoardPostTitle: 'Choose a post',
  homeShortcutPickBoardPostHint: 'Pick a board post to open from home.',
  homeShortcutPickBoardPostSearch: 'Search title',
  homeShortcutPickBoardPostEmpty: 'No posts to show.',
