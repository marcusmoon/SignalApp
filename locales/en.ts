...
export const en = {
  ...
  settingsHomeVariantSection: 'Home layout',
  settingsHomeVariantHint: 'Choose the current home or the new focus-first home.',
  settingsHomeVariantClassic: 'Classic',
  settingsHomeVariantFocus: 'New home',
  settingsHomeWatchlistDisplaySection: 'Home watchlist',
  settingsHomeWatchlistDisplayHint: 'Choose how many watchlist items to show on the new home.',
