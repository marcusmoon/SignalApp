...
export const en = {
  ...
  homeQuantSection: 'Price analysis',
  homeSeeAll: 'All',
  ...
  screenQuant: 'Quant analysis',
  screenMarket: 'Market snapshot',
  screenSymbolDetail: 'Symbol detail',
  quantSubtitle: 'Analyzes the top 20 KOSPI market-cap candidates with trend, momentum and mean-reversion factors, then shows the top 10.',
  quantEmpty: 'No daily-bar data is ready for analysis yet.',
  quantError: 'Could not load quant analysis.',
  ...
  quantActionBuy: 'Buy',
  quantActionAccumulate: 'Accumulate',
  quantActionHold: 'Hold',
  quantActionReduce: 'Reduce',
  quantActionAvoid: 'Avoid',
  ...
  symbolDetailQuantSection: 'Price analysis',
