...
export const ja = {
  ...
  quantSubtitle: 'ウォッチリストを価格モメンタムとデータ鮮度でスコア化します。',
  quantEmpty: 'スコア化できるウォッチリストの価格情報がまだありません。',
  quantError: 'クオンツスコアを読み込めませんでした。',
  quantScore: 'スコア',
  quantRiskLow: '変動低め',
  quantRiskMedium: '変動中',
  quantRiskHigh: '変動大',
  quantFactorMomentum: 'モメンタム',
  quantFactorRegular: '通常取引',
  quantFactorFreshness: '鮮度',
  quantReasonAfterHoursUp: '夜間参考価格が強い',
  quantReasonAfterHoursDown: '夜間参考価格が弱い',
  quantReasonRegularUp: '通常取引で上昇',
  quantReasonRegularDown: '通常取引で下落',
  quantReasonAfterHoursSource: 'デリバティブ参考',
  quantReasonFreshQuote: '新しい価格',
  quantReasonStaleQuote: '価格確認が必要',
  quantReasonPriceStable: '価格安定',
