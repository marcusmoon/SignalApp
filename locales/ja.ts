...
export const ja = {
  ...
  todayBriefingLoadError: '引けブリーフィングを読み込めませんでした。',
  todayBriefingEmpty: 'この日付の引けブリーフィングはありません。',
  todayBriefingDetailKicker: '引けブリーフィング',
  ...
  homeEtfInsightTitle: 'ETFインサイト',
  homeEtfInsightEmpty: 'この日付のETFインサイトはありません。',
  etfInsightDetailKicker: 'ETFインサイト',
  etfInsightKeyPoints: '要点',
  etfInsightThemes: 'テーマ',
  etfInsightFlows: '資金フロー',
  etfInsightFlowInflow: '流入',
  etfInsightFlowOutflow: '流出',
  etfInsightFlowOpenSource: '出典を開く',
  etfInsightHeatmap: 'ヒートマップ',
  etfInsightRotation: 'ローテーション',
  etfInsightSources: '出典',
  etfInsightPeriodLabel: '{{period}}',
  etfInsightLoadError: 'ETFインサイトを読み込めませんでした。',
  etfInsightEmpty: '表示するETFインサイトはありません。',
  etfInsightListEmpty: '登録されたETFインサイトはありません。',
  ...
  settingsBriefingPushEnabledHint: '引けブリーフィング、ニュースフロー、市場ブリーフィングの到着を通知とプッシュで受け取ります。',
