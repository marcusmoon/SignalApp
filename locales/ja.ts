...
export const ja = {
  ...
  settingsHomeBoardDisplayHint: 'ホームの掲示板で、出所ごとに表示する最新投稿数です。',
  settingsHomeBoardDisplayValue: '出所あたり{{count}}件',
  ...
  disclosuresFocusAll: 'すべて',
  disclosuresFocusImportant: '重要',
  disclosuresImportantBadge: '重要',
  disclosuresEmpty: '表示する開示はありません。',
  disclosuresEmptyImportant: '重要な開示はありません。',
