...
export const ja = {
  ...
  todayBriefingLoadError: '引け市況を読み込めませんでした。',
  todayBriefingEmpty: 'この日付の引け市況はありません。',
  todayBriefingDetailKicker: '引け市況',
