...
export const ja = {
  ...
  settingsHomeNewsFlowDisplayHint: 'ホームに表示するニュースの件数を選びます。',
  settingsHomeNewsFlowDisplayValue: '{{count}}件表示',
  settingsHomeWatchlistDisplaySection: 'ウォッチリスト',
  settingsHomeWatchlistDisplayHint: 'ホームに表示するウォッチリストの件数を選びます。',
  settingsHomeWatchlistDisplayValue: '{{count}}件表示',
  settingsHomeBoardDisplaySection: '掲示板',
  settingsHomeBoardDisplayHint: 'ホームの掲示板ごとに表示する最新投稿数です。',
  settingsHomeBoardDisplaySourceValue: '{{board}} {{count}}件',
  settingsHomeMarketBriefingDisplaySection: '市場ブリーフィング',
  settingsHomeMarketBriefingDisplayHint: 'ホームに表示する直近の市場ブリーフィング回数を選びます。',
  settingsHomeMarketBriefingDisplayValue: '{{count}}件表示',
  ...
  accountHubDisplaySettingsDesc: 'テーマ、文字サイズ、ホーム表示オプションを調整します。',
