...
export const ja = {
  ...
  settingsHomeWatchlistDisplaySection: 'ホームのウォッチリスト',
  ...
  newsDigestViewModeDigest: 'イシュー要約',
  newsDigestViewModeLive: '最新記事',
  newsDigestFeedRecentSectionTitle: '最新記事',
  newsDigestFeedRecentSectionHint: '下の要約一覧にはまだ出ていない場合があります。',
  newsDigestFeedDigestSectionTitle: 'イシュー要約',
  newsDigestFeedDigestSectionHint: '直近{{hours}}時間',
  newsDigestFeedShowAllRecent: 'すべて見る',
  newsDigestFeedLiveSectionHint: '要約一覧にない記事をまとめて表示します。',
  newsDigestFeedRealtimeEmpty: '表示できる最新記事がありません。',
  ...
  symbolDetailSectionDisclosures: '開示・資料',
