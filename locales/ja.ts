...
export const ja = {
  focusNewsTitle: '注目対象の変化',
  focusNewsTab: '注目ニュース',
  focusNewsPeriod: '選択日までの7日間 · 新しい順',
  focusNewsEmpty: 'この7日間に関連トピックはありません。',
  focusNewsMore: '続きを見る',
  newsRevisionCorrection: '訂正内容',
  newsRevisionUpdate: '追加情報',
  newsRevisionFacts: '主な事実',
  newsPreviousUpdates: 'これまでの経緯',
  newsHistoryRetry: '経緯を再読み込み',
  newsSave: 'この端末に保存',
  newsUnsave: '保存を解除',
  newsSaveFailed: '保存できませんでした。',
  newsSaved: '保存済み',
  newsSavedEmpty: 'この端末に保存した記事はありません。',
  companyTimeline: '最近の動向',
  companyTimelineRetry: '一部の情報を取得できませんでした。再試行',
  companyUpcomingEarnings: '今後の決算',
  companyBriefing: '市場ブリーフィング',
  homeNewsAll: 'すべて',
  homeNewsWatch: 'ウォッチリスト',
  homeNewsRead: '既読',
  homeNewsUnavailable: '情報を読み込めませんでした。',
  homeNewsNoWatchlist: '登録した銘柄はありません。',
  homeNewsNoMatch: 'この日の登録銘柄のニュースはありません。',
  homeNewsManageWatchlist: 'ウォッチリストを管理',
  homePartialLoadError: '{{sections}}を更新できませんでした。取得済みの情報は保持されます。',
  homeReadBriefing: 'ブリーフィング全文',
  commonBack: '戻る',
  commonCancel: 'キャンセル',
  filterSheetDone: '完了',
  ...
  digestCopyText: 'コピー',
  digestCopyTextA11y: 'タイトルと要約をコピー',
  digestCopyDone: 'コピーしました',
  digestCopyFailed: 'コピーできませんでした。',
  ...
  settingsHomeDisplayHint:
    'ホームのウォッチ・セクター・ニュース件数を調整します。ヒーロー・予定チップは自動です。',
  settingsHomeNewsFlowDisplaySection: 'ニュース',
  settingsHomeNewsFlowDisplayHint: 'ホームに表示するニュース件数を選びます。',
  ...
  settingsHomeSectorFlowDisplaySection: 'セクター',
  settingsHomeSectorFlowDisplayHint: 'ホームのセクターヒートマップに表示するセル数を選びます。',
  ...
  todayBriefingLoadError: 'まとめを読み込めませんでした。',
  todayBriefingEmpty: 'この日付のまとめはありません。',
  todayBriefingDetailKicker: 'まとめ',
  ...
  homeFocusSignalEmpty: '表示するセッションがありません。',
  ...
  homeEtfInsightTitle: 'セクター',
  homeEtfInsightEmpty: 'この日付のセクターはありません。',
  etfInsightDetailKicker: 'セクター',
  ...
  etfInsightLoadError: 'セクターを読み込めませんでした。',
  etfInsightEmpty: '表示するセクターはありません。',
  etfInsightListEmpty: '登録されたセクターはありません。',
  newsIssuesTitle: 'ニュース',
  newsIssuesCategoryAll: 'すべて',
  newsIssuesEmpty: 'この日付のニュースはありません。',
  newsIssuesLoadError: 'ニュースを読み込めませんでした。',
  newsDigestEmpty: '表示するニュースはありません。',
  ...
  calendarScopeMeaningful: '主要',
  calendarScopeFull: '全指標',
  calendarSectionPolicy: '金融政策',
  calendarSectionMacro: '主要指標',
  calendarSectionEarnings: 'ウォッチ',
  calendarSectionHoliday: '休場',
  calendarScreenEmptyDayMeaningful: 'この日に主要予定はありません。',
  calendarFilterEmptyMeaningful: '今月は主要予定がありません。',
  ...
  accountHubDisplaySettingsDesc:
    'テーマ、文字サイズ、タブ新着確認間隔、ホームのウォッチ・ニュース件数を調整します。',
  ...
  settingsFeedContentWeightHint:
    'ホーム（ヒーロー・ウォッチ・ニュース）、ニュース・株価一覧、YouTubeカードの文字の太さと行の余白に適用されます。',
  ...
  settingsBriefingPushEnabledHint: 'まとめ、ニュース、セッションの到着を通知とプッシュで受け取ります。',
  ...
  alertsTypeTodayBriefing: 'まとめ',
  alertsTypeMarketBriefing: 'セッション',
  ...
  feedDigestTailGoToNewsFlowA11y: 'ニュースへ移動',
