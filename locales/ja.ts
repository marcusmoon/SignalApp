...
export const ja = {
  ...
  quantSubtitle: 'KOSPI時価総額上位20候補を日足のトレンド・モメンタム・過熱度で分析し、上位10件を表示します。',
  quantEmpty: '分析できる日足データがまだありません。',
  quantError: 'クオンツ分析を読み込めませんでした。',
  ...
  quantActionBuy: '買い',
  quantActionAccumulate: '分割買い',
  quantActionHold: '様子見',
  quantActionReduce: '比率縮小',
  quantActionAvoid: '回避',
