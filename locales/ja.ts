...
export const ja = {
  ...
  settingsHomeVariantSection: 'ホーム画面構成',
  settingsHomeVariantHint: '現在のホームまたは重要情報中心の新ホームを選びます。',
  settingsHomeVariantClassic: '従来',
  settingsHomeVariantFocus: '新ホーム',
  settingsHomeWatchlistDisplaySection: 'ホームのウォッチリスト',
  settingsHomeWatchlistDisplayHint: '新ホームに表示するウォッチリストの件数を選びます。',
