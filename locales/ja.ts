...
export const ja = {
  ...
  settingsHomeDisplaySection: 'ホーム',
  settingsHomeDisplayHint:
    'ホームのショートカット・ウォッチ・セクター動向・ニュースフローを調整します。ヒーロー・予定チップは自動です。',
  ...
  settingsHomeShortcutsSection: 'ショートカット',
  settingsHomeShortcutsHint: 'ホーム中央のショートカットを選びます。最大{{count}}個。',
