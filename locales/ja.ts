...
export const ja = {
  ...
  newsDigestFeedHeadlineSectionTitle: '最新ヘッドライン',
  newsDigestFeedTimelineSectionTitle: 'タイムライン',
  newsDigestFeedRecentWindowMeta: '直近{{hours}}時間',
  newsDigestFeedOpenTimeline: 'タイムラインを見る',
  newsDigestFeedCloseTimeline: '閉じる',
