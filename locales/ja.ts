...
export const ja = {
  ...
  accountSocialTitle: 'ソーシャルログイン準備中',
  ...
  accountTermsText: 'SIGNAL の基本利用規約とプライバシー案内に同意します。市場情報は参考用であり、投資判断の責任はユーザーにあります。',
  accountTermsRequired: '登録には基本規約への同意が必要です。',
  ...
  settingsSignalAlertsEnabled: '今日のシグナル通知候補',
  settingsSignalAlertsHint: 'Insight Job が作成したプッシュ候補を通知画面で先に確認します。',
  settingsSignalWatchlistOnly: 'ウォッチ銘柄のみ',
  settingsSignalWatchlistOnlyHint: 'ウォッチ銘柄に関連するシグナル候補だけを表示します。',
  ...
  alertsLoginRequiredButton: 'アカウントへ',
