...
export const ja = {
  ...
  homeEvidenceFallback: '関連ニュースと動画が準備できるとここに表示されます。',
  homeEvidenceNewsFallback: '最新ニュースが準備できるとここに表示されます。',
  homeEvidenceYoutubeFallback: '関連動画が準備できるとここに表示されます。',
  ...
  feedSegmentVideo: '動画',
  feedEmptyWatch: 'ウォッチリストに関連する最新ニュースがありません。銘柄を追加するかグローバルを確認してください。',
  feedEmptyVideo: '表示する動画がありません。YouTube 全体画面を確認するか、しばらくしてから更新してください。',
