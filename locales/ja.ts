...
export const ja = {
  ...
  gameHubResumeMahjong: '続き · 残り{{count}}枚',
  ...
  gameBlockPuzzleBlurb:
    '左ボタン（または盤面スワイプ）で移動・落下、右ボタンで回転・即落下です。横一列が揃うと消えて得点。10ラインごとに速度アップ。積み上がりきるとゲームオーバーです。',
  ...
  gameMahjongTitle: '麻雀ソリティア',
  gameMahjongCardBody: '重なった牌から同じペアを見つけてすべて消すパズル',
  gameMahjongKicker: '同じ牌を2枚選んで消そう',
  gameMahjongBlurb:
    '上に牌がなく、左右どちらかが空いている牌だけ選べます。すべて消すとクリア。ペアがなくなると詰みです。',
  gameMahjongHowTo: '遊び方',
  gameMahjongHelpShowA11y: '遊び方を見る',
  gameMahjongDiffEasy: 'かんたん',
  gameMahjongDiffNormal: 'ふつう',
  gameMahjongDiffHard: 'むずかしい',
  gameMahjongScore: 'スコア',
  gameMahjongRemaining: '残り牌',
  gameMahjongTime: '時間',
  gameMahjongHint: 'ヒント {{count}}',
  gameMahjongUndo: '元に戻す',
  gameMahjongNewGame: '新しいゲーム',
  gameMahjongMatchFx: 'ペア成立！',
  gameMahjongCleared: 'クリア！',
  gameMahjongClearedScore: 'スコア {{score}}',
  gameMahjongStuck: '詰み',
  gameMahjongStuckBody: 'ペアがありません。新しいゲームを始めましょう。',
