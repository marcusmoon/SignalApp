...
export const ja = {
  ...
  settingsHomeDisplayHint:
    'ホームのウォッチ・セクター動向・ニュース件数を調整します。ヒーロー・予定は自動です。',
  settingsHomeNewsFlowDisplaySection: 'ニュース',
  settingsHomeNewsFlowDisplayHint: 'ホーム下部のニュース表示件数を選びます。',
  ...
  accountHubDisplaySettingsDesc: 'テーマ、文字サイズ、ホームのウォッチ・ニュース件数を調整します。',
