...
export const ja = {
  ...
  homeBriefingAction: '市場ブリーフィングを開く',
  newsOpenVideos: '動画',
  ...
  accountActivityBriefing: '市場ブリーフィング',
  accountActivityBriefingDesc: '韓国・米国の自動ブリーフィングをまとめて確認します。',
  feedBriefingCtaTitle: '市場ブリーフィング',
  ...
  briefingMarketBriefingsTitle: '市場ブリーフィング',
  briefingHubEyebrow: 'Signal Market Brief',
  briefingHubTitle: '今日の市場を先に整理',
  briefingHubSubtitle: '韓国市場は1日3回、米国市場は夜間ブリーフを一画面で確認できます。',
  briefingHubWaitingBadge: '待機中',
  briefingHubOpenDetail: '全文を見る',
  briefingHubOpenBrief: '見る',
  briefingHubEmptyTitle: 'まだ市場ブリーフィングが生成されていません。',
  briefingHubEmptyBody: 'Codex自動化がSignal Serverへ最初のブリーフを送るとここに表示されます。',
  briefingHubMarketEmptyTitle: '選択した市場のブリーフはまだありません。',
  briefingHubMarketEmptyBody: '別の市場にはブリーフがあります。この市場の自動化が実行されると回次別に表示されます。',
  briefingHubTimelineTitle: '回次別ブリーフ',
  briefingHubTimelineEmpty: 'まだ前の回次はありません。',
  briefingHubTimelineWaiting: '自動生成された回次がここに蓄積されます。',
  briefingHubWatchKicker: 'My Watch',
  briefingHubWatchTitle: 'ウォッチ確認',
  briefingMarketKr: '韓国',
  briefingMarketUs: '米国',
  briefingSessionMorning: '朝',
  briefingSessionLunch: '昼',
  briefingSessionEvening: '夕方',
