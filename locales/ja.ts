...
export const ja = {
  ...
  settingsHomeBoardPostsSection: '掲示板投稿',
  settingsHomeBoardPostsHint: '特定の投稿をホームショートカットに追加します。',
  settingsHomeBoardPostAdd: '投稿を追加',
  settingsHomeBoardPostRemove: '投稿ショートカットを削除',
  homeShortcutsTitle: 'ショートカット',
  homeShortcutNewsIt: 'ITニュース',
  homeShortcutBoardPost: '投稿',
  homeShortcutPickBoardPostTitle: '投稿を選ぶ',
  homeShortcutPickBoardPostHint: 'ホームから開く掲示板投稿を選びます。',
  homeShortcutPickBoardPostSearch: 'タイトル検索',
  homeShortcutPickBoardPostEmpty: '表示する投稿がありません。',
