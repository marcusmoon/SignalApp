...
export const ja = {
  ...
  youtubeDetailOpen: 'YouTubeで開く',
  youtubeDetailSectionVideo: '動画情報',
  youtubeDetailSectionChannel: 'チャンネル情報',
  youtubeDetailViews: '再生',
  youtubeDetailLikes: '高評価',
  youtubeDetailComments: 'コメント',
  youtubeDetailDuration: '長さ',
  youtubeDetailDescriptionEmpty: '動画説明がありません。',
  youtubeDetailSubscribers: '登録者 {{count}}',
  youtubeDetailVideos: '動画 {{count}}',
  youtubeDetailCaptions: '字幕',
  youtubeDetailHd: 'HD',
