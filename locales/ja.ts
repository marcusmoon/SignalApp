...
export const ja = {
  ...
  ipadHomeSignalTitle: 'シグナル',
  ipadHomeSignalSubtitle: '市場ブリーフィング要約',
  ...
  todayBriefingDisclosureDigestTitle: '主要開示',
  todayBriefingDisclosureDigestSubtitle: '今日の注目開示',
  todayBriefingDisclosureDigestEmpty: '今日表示する主要開示はありません。',
  todayBriefingReadMore: '全文を見る',
  todayBriefingKeyPoints: '要点',
  todayBriefingSources: '出典',
  todayBriefingLoadError: '今日のブリーフィングを読み込めませんでした。',
  todayBriefingEmpty: 'この日付のブリーフィングはありません。',
  todayBriefingDetailKicker: '引けブリーフィング',
  ipadHomeLoadError: 'ホーム情報を読み込めませんでした。',
  homeFocusHeroKicker: '主要イシュー',
  homeFocusSourceCount: '出典 {{count}}件',
  homeFocusWatchTitle: 'ウォッチリスト',
  homeFocusSignalTitle: 'シグナル',
  homeFocusSignalEmpty: '表示するシグナルがありません。',
  newsIssuesTitle: '主要イシュー',
  newsIssuesEmpty: 'この日付の主要イシューはありません。',
  newsIssuesLoadError: '主要イシューを読み込めませんでした。',
