...
export const ko = {
  ...
  settingsHomeWatchlistDisplayHint: '홈에 표시할 관심 종목 수를 선택합니다.',
  settingsHomeWatchlistDisplayValue: '{{count}}개 표시',
  settingsHomeBoardDisplaySection: '게시판',
  settingsHomeBoardDisplayHint: '홈에 표시할 게시판별 최근 글 수입니다.',
  settingsHomeBoardDisplaySourceValue: '{{board}} {{count}}개',
  settingsHomeMarketBriefingDisplaySection: '시장 브리핑',
  settingsHomeMarketBriefingDisplayHint: '홈에 표시할 최근 시장 브리핑 회차 수를 선택합니다.',
  settingsHomeMarketBriefingDisplayValue: '{{count}}개 표시',
  ...
  screenSignal: '시장',
  ipadHomeTitle: '마감 브리핑',
  ipadHomeTodayBriefingSubtitle: '뉴스·시장·시세 종합',
  ipadHomeIssuesSubtitle: '시간순 핵심 뉴스 흐름',
  ipadHomeIssuesEmpty: '표시할 뉴스 흐름이 없습니다.',
  ipadHomeSignalTitle: '시장 브리핑',
  ipadHomeSignalSubtitle: '하루 4회 회차별 요약',
  ipadHomeCalendarTitle: '투자 일정',
  ipadHomeCalendarSubtitle: '경제지표 · 실적 · FOMC',
  ipadHomeCalendarMore: '외 {{count}}건',
  ipadHomeCalendarEmpty: '오늘 예정된 일정이 없습니다.',
  ...
  todayBriefingLoadError: '마감 브리핑을 불러오지 못했습니다.',
  todayBriefingEmpty: '이 날짜의 마감 브리핑이 없습니다.',
  todayBriefingDetailKicker: '마감 브리핑',
  ...
  homeEtfInsightTitle: 'ETF 인사이트',
  homeEtfInsightEmpty: '이 날짜의 ETF 인사이트가 없습니다.',
  etfInsightDetailKicker: 'ETF 인사이트',
  etfInsightKeyPoints: '핵심 포인트',
  etfInsightThemes: '테마',
  etfInsightFlows: '수급 하이라이트',
  etfInsightFlowInflow: '유입',
  etfInsightFlowOutflow: '유출',
  etfInsightFlowOpenSource: '출처 보기',
  etfInsightHeatmap: '히트맵',
  etfInsightRotation: '로테이션',
  etfInsightSources: '출처',
  etfInsightPeriodLabel: '{{period}}',
  etfInsightLoadError: 'ETF 인사이트를 불러오지 못했습니다.',
  etfInsightEmpty: '표시할 ETF 인사이트가 없습니다.',
  etfInsightListEmpty: '등록된 ETF 인사이트가 없습니다.',
  ...
  accountHubDisplaySettingsDesc: '화면 테마, 글자 크기, 홈 표시 옵션을 조정합니다.',
  ...
  settingsBriefingPushEnabledHint: '마감 브리핑, 뉴스 흐름, 시장 브리핑이 도착하면 알림함과 푸시로 받습니다.',
