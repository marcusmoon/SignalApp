...
export const ko = {
  ...
  gameHubResumeMahjong: '이어하기 · {{count}}장 남음',
  ...
  gameBlockPuzzleBlurb:
    '좌·우·회전·빠른 낙하로 블록을 배치합니다. 가로 줄이 가득 차면 지워지고 점수를 얻습니다. 10줄마다 속도가 빨라집니다. 더 쌓을 공간이 없으면 게임 오버입니다.',
  ...
  gameMahjongTitle: '마작 짝 맞추기',
  gameMahjongCardBody: '겹친 타일에서 같은 짝을 찾아 모두 제거하는 퍼즐',
  gameMahjongKicker: '같은 타일 두 장을 골라 없애세요',
  gameMahjongBlurb:
    '위에 다른 타일이 없고, 왼쪽 또는 오른쪽이 열린 타일만 고를 수 있습니다. 모든 타일을 지우면 클리어입니다. 더 이상 짝이 없으면 막힙니다.',
  gameMahjongHowTo: '플레이 방법',
  gameMahjongHelpShowA11y: '플레이 방법 보기',
  gameMahjongDiffEasy: '쉬움',
  gameMahjongDiffNormal: '보통',
  gameMahjongDiffHard: '어려움',
  gameMahjongScore: '점수',
  gameMahjongRemaining: '남은 타일',
  gameMahjongTime: '시간',
  gameMahjongHint: '힌트 {{count}}',
  gameMahjongUndo: '되돌리기',
  gameMahjongNewGame: '새 게임',
  gameMahjongMatchFx: '짝 맞춤!',
  gameMahjongCleared: '클리어!',
  gameMahjongClearedScore: '점수 {{score}}',
  gameMahjongStuck: '막힘',
  gameMahjongStuckBody: '더 이상 짝이 없습니다. 새 게임을 시작해 보세요.',
