...
export const ko = {
  ...
  settingsHomeWatchlistDisplaySection: '홈 관심 종목',
  ...
  newsDigestViewModeDigest: '이슈 요약',
  newsDigestViewModeLive: '최신 기사',
  newsDigestFeedRecentSectionTitle: '최신 기사',
  newsDigestFeedRecentSectionHint: '아래 이슈 요약에는 아직 안 보일 수 있어요.',
  newsDigestFeedDigestSectionTitle: '이슈 요약',
  newsDigestFeedDigestSectionHint: '최근 {{hours}}시간',
  newsDigestFeedShowAllRecent: '전체 보기',
  newsDigestFeedLiveSectionHint: '이슈 요약 목록에 없는 기사를 모아 보여줘요.',
  newsDigestFeedRealtimeEmpty: '표시할 최신 기사가 없어요.',
  ...
  symbolDetailSectionDisclosures: '공시/자료',
