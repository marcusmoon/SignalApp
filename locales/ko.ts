...
export const ko = {
  ...
  settingsNotificationsLead:
    '서버 푸시, 인사이트 알림함, 경제 일정 로컬 알림을 각각 켜고 끌 수 있습니다.',
  settingsPushEnabled: '푸시 알림',
  settingsPushEnabledHint: '서버 푸시를 이 기기로 받을지 설정합니다. 로그인 후 등록됩니다. 아래에서 종류별로 켜고 끌 수 있습니다.',
  settingsBriefingPushEnabled: '시장 브리핑 푸시',
  settingsBriefingPushEnabledHint: '장전·장후·오버나잇 등 시장 브리핑이 도착하면 알림으로 받습니다.',
  settingsInsightPushEnabled: '인사이트 푸시',
  settingsInsightPushEnabledHint: '서버가 선정한 종목·시장 인사이트가 푸시로 도착하면 알림으로 받습니다.',
  settingsEarningsOnly: '실적 알림만',
  settingsSignalAlertsEnabled: '인사이트 알림',
  settingsSignalAlertsHint: '알림 탭에 서버가 만든 종목·시장 인사이트 후보를 표시합니다. 푸시와 별도입니다.',
  settingsSignalWatchlistOnly: '관심종목만 보기',
  settingsSignalWatchlistOnlyHint: '켜두면 관심종목과 연결된 인사이트 후보만 알림 탭에 표시합니다.',
