...
export const ko = {
  ...
  youtubeDetailOpen: 'YouTube에서 열기',
  youtubeDetailSectionVideo: '영상 정보',
  youtubeDetailSectionChannel: '채널 정보',
  youtubeDetailViews: '조회',
  youtubeDetailLikes: '좋아요',
  youtubeDetailComments: '댓글',
  youtubeDetailDuration: '길이',
  youtubeDetailDescriptionEmpty: '영상 설명이 없습니다.',
  youtubeDetailSubscribers: '구독자 {{count}}',
  youtubeDetailVideos: '영상 {{count}}',
  youtubeDetailCaptions: '자막',
  youtubeDetailHd: 'HD',
