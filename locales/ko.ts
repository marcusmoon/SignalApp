...
export const ko = {
  ...
  quantSubtitle: '관심종목을 가격 모멘텀과 데이터 신선도로 점수화합니다.',
  quantEmpty: '점수화할 관심종목 시세가 아직 없습니다.',
  quantError: '퀀트 점수를 불러오지 못했습니다.',
  quantScore: '점수',
  quantRiskLow: '변동 낮음',
  quantRiskMedium: '변동 보통',
  quantRiskHigh: '변동 큼',
  quantFactorMomentum: '모멘텀',
  quantFactorRegular: '정규장',
  quantFactorFreshness: '신선도',
  quantReasonAfterHoursUp: '야간 참고가 강세',
  quantReasonAfterHoursDown: '야간 참고가 약세',
  quantReasonRegularUp: '정규장 상승',
  quantReasonRegularDown: '정규장 하락',
  quantReasonAfterHoursSource: '해외 파생 반영',
  quantReasonFreshQuote: '최근 시세',
  quantReasonStaleQuote: '시세 확인 필요',
  quantReasonPriceStable: '가격 안정',
