...
export const ko = {
  ...
  settingsHomeBoardPostsSection: '게시판 글',
  settingsHomeBoardPostsHint: '특정 게시글을 홈 바로가기에 추가합니다.',
  settingsHomeBoardPostAdd: '게시글 추가',
  settingsHomeBoardPostRemove: '게시글 바로가기 삭제',
  homeShortcutsTitle: '바로가기',
  homeShortcutNewsIt: 'IT 뉴스',
  homeShortcutBoardPost: '게시글',
  homeShortcutPickBoardPostTitle: '게시글 선택',
  homeShortcutPickBoardPostHint: '홈 바로가기로 열 게시글을 고릅니다.',
  homeShortcutPickBoardPostSearch: '제목 검색',
  homeShortcutPickBoardPostEmpty: '표시할 게시글이 없습니다.',
