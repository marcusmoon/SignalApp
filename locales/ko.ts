...
export const ko = {
  ...
  tabMore: '더보기',
  homeEyebrow: '오늘의 브리핑',
  homeMoodActive: '바로 확인할 시그널이 있어요',
  homeMoodWatch: '관심종목에서 움직임이 커진 항목을 확인해요',
  homeMoodQuiet: '오늘은 핵심 흐름만 가볍게 확인해요',
  homePulseHeadline: '관심종목 {{count}}개 중 {{movers}}개가 움직였어요',
  homePulseQuiet: '관심종목의 큰 변동은 아직 없어요',
  homeFocusKicker: '지금 볼 시그널',
  homeBriefingKicker: '최신 시장 브리핑',
  homeFocusFallbackTitle: '시장 흐름을 정리 중입니다',
  homeFocusFallbackBody: '관심종목과 최신 뉴스가 쌓이면 바로 확인할 신호를 먼저 보여줍니다.',
  homeFocusOpenSignals: '시그널 전체보기',
  homeFocusOpenBriefing: '시장 브리핑',
  homeOverviewSignals: '시그널',
  homeOverviewBriefings: '브리핑',
  homeOverviewWatch: '관심종목',
  homeOverviewRelated: '관련뉴스',
  homeNextSignals: '다음 시그널',
  homePillSignals: '시그널 {{count}}개',
  homePillWatchlist: '관심 {{count}}개',
  homePillEvidence: '관련 {{count}}개',
  homeTodaySection: '핵심 시그널',
  homeWatchSection: '관심종목',
  homeEvidenceSection: '관련 자료',
  homeRelatedSection: '관련뉴스',
  homeQuantSection: '투자 관점',
  homeSeeAll: '전체',
  homeOpenSignals: '시그널 보기',
  homeOpenQuotes: '시세',
  homeOpenQuotesFull: '시세 보기',
  homeOpenNews: '뉴스',
  homeOpenNewsFull: '뉴스 보기',
  homeWatchReason: '관심종목',
  homeWatchNewsCount: '관련뉴스 {{count}}',
  homeWatchReasonPriceSurge: '급등',
  homeWatchReasonPriceDrop: '급락',
  homeWatchReasonPriceMove: '가격 변동',
  homeWatchReasonNewsDense: '뉴스 집중',
  homeWatchReasonNewsActive: '뉴스 증가',
  homeWatchReasonInsightAlert: '중요 시그널',
  homeWatchReasonInsightWatch: '시그널 감지',
  homeWatchReasonVideoActive: '영상 증가',
  homeWatchReasonEarningsSoon: '실적 임박',
  homeWatchReasonEventSoon: '일정 임박',
  homeWatchReasonQuiet: '관찰',
  homeEmptySignals: '표시할 시그널이 아직 없습니다.',
  homeEmptyWatchlist: '관심종목을 추가하면 여기에서 바로 확인할 수 있습니다.',
  homeEvidenceFallback: '표시할 관련 콘텐츠가 없습니다.',
  homeEvidenceNewsFallback: '표시할 뉴스가 없습니다.',
  homeEvidenceYoutubeFallback: '표시할 영상이 없습니다.',
  homeBriefingAction: '시장 브리핑 열기',
  newsOpenVideos: '영상',
  ...
  settingsEntryHome: '홈',
  settingsEntryNews: '뉴스',
  settingsEntryBriefing: '브리핑',
  settingsEntryQuotes: '시세',
  settingsEntryYoutube: '유튜브',
  settingsEntryMore: '더보기',
  settingsAppIconSection: '앱 아이콘',
  settingsAppIconHint: '홈 화면에 표시할 SIGNAL 앱 아이콘 색상을 선택합니다.',
  settingsAppIconNativeNote: 'iOS에서는 선택 즉시 홈 화면 아이콘에 적용됩니다.',
  ...
  quantSubtitle: '코스피 주요 종목을 가격 흐름·거래량·과열도·리스크 관점으로 점검합니다. 매수 추천이 아니라 볼 이유와 주의점을 정리합니다.',
  quantEmpty: '점검할 가격 데이터가 아직 없습니다.',
  quantError: '투자 관점을 불러오지 못했습니다.',
  quantRankBadge: '코스피 {{rank}}위',
  quantScore: '체크',
  quantConfidence: '신뢰도',
  quant20dReturn: '20일',
  quantRiskLow: '변동 낮음',
  quantRiskMedium: '변동 보통',
  quantRiskHigh: '변동 큼',
  quantRiskUnknown: '변동 미정',
  quantActionBuy: '관심',
  quantActionAccumulate: '분할 관찰',
  quantActionHold: '확인 대기',
  quantActionReduce: '리스크 관리',
  quantActionAvoid: '보류',
  quantFactorTrend: '추세',
  quantFactorMomentum: '모멘텀',
  quantFactorMeanReversion: '과열도',
  quantFactorVolume: '거래량',
  quantIndicatorRsi: 'RSI',
  quantIndicatorSma20: '20일선 이격',
  quantIndicatorVol: '변동성',
  quantReasonTrendUp: '상승 추세',
  quantReasonTrendDown: '하락 추세',
  quantReasonGoldenCross: '정배열 구간',
  quantReasonDeadCross: '역배열 구간',
  quantReasonMomentumStrong: '강한 모멘텀',
  quantReasonMomentumWeak: '약한 모멘텀',
  quantReasonNear52wHigh: '52주 고점 부근',
  quantReasonNear52wLow: '52주 저점 부근',
  quantReasonOverbought: '과매수',
  quantReasonOverboughtMild: '과매수 주의',
  quantReasonOversold: '과매도',
  quantReasonOversoldMild: '과매도 주의',
  quantReasonVolumeSpike: '거래량 급증',
  quantReasonVolumeActive: '거래량 활발',
  quantReasonVolumeDry: '거래량 위축',
  quantReasonRangeBound: '횡보 구간',
  quantPerspectiveLabel: '관점',
  quantPerspectivePrinciple: '판단 기준',
  quantPerspectivePositive: '볼 이유',
  quantPerspectiveCaution: '주의할 점',
  quantChecklistScore: '체크 점수',
  quantLensHealth: '기업 체력',
  quantLensTiming: '매수 타이밍',
  quantLensRisk: '리스크',
  quantLensScenario: '장기 시나리오',
  quantLensHealthScore: '체력',
  quantLensRiskScore: '위험',
  quantLensScenarioScore: '유효성',
  quantLensStatusStrong: '좋음',
  quantLensStatusWatch: '주목',
  quantLensStatusNeutral: '관망',
  quantLensStatusWeak: '약함',
  quantLensStatusRiskHigh: '경고',
  quantLensStatusRiskWatch: '주의',
  quantLensStatusRiskLow: '안정',
  quantLensHealthBulletTrend: '추세 체력 {{value}}점입니다.',
  quantLensHealthBulletMomentum: '모멘텀 점수는 {{value}}점입니다.',
  quantLensHealthBulletConfidence: '데이터 신뢰도는 {{value}}점입니다.',
  quantLensTimingPullback: '20일선 대비 {{value}}로 눌림 구간입니다.',
  quantLensTimingTrend: '20일선 대비 {{value}} 위치입니다.',
  quantLensTimingBulletMomentum: '20일 수익률은 {{value}}입니다.',
  quantLensRiskBulletVolatility: '변동성은 {{value}}입니다.',
  quantLensRiskBulletRsi: 'RSI는 {{value}}입니다.',
  quantLensScenarioBulletThesis: '추세와 리스크가 장기 관점 유지 여부를 좌우합니다.',
  quantLensScenarioBulletTrend: '장기 체크용 추세 점수는 {{value}}점입니다.',
  quantLensScenarioBulletCheckpoint: '다음 체크포인트는 추세 훼손과 변동성 확대입니다.',
  quantLensDataBars: '데이터',
  ...
  accountProfileEditLead: '닉네임과 프로필 이미지를 수정합니다.',
  ...
  accountActivityAlerts: '알림함',
  accountActivityAlertsDesc: '공지와 관심종목 알림을 확인합니다.',
  accountActivitySignals: '오늘의 시그널',
  accountActivitySignalsDesc: '날짜별로 생성된 시그널을 봅니다.',
  accountActivityBriefing: '시장 브리핑',
  accountActivityBriefingDesc: '국내·미국 자동화 브리핑을 모아봅니다.',
  feedBriefingCtaTitle: '시장 브리핑',
  ...
  settingsNotificationsLead:
    '자주 볼 알림만 남기고, 세부 조건은 관심종목 중심으로 단순하게 관리합니다.',
  settingsPushEnabled: '푸시 알림',
  settingsPushEnabledHint: '공지, 오늘의 시그널, 일정 리마인더를 기기로 받습니다.',
  settingsEarningsOnly: '실적 알림만',
  settingsSignalAlertsEnabled: '오늘의 시그널',
  settingsSignalAlertsHint: '서버가 생성한 중요한 시그널을 알림함과 푸시 후보로 사용합니다.',
  settingsSignalWatchlistOnly: '관심종목만 받기',
  settingsSignalWatchlistOnlyHint: '켜두면 내 관심종목과 연결된 시그널만 보여줍니다.',
  ...
  insightListLead: '점수 순으로 정렬된 인사이트입니다. 카드를 누르면 관련 기사·영상으로 이동합니다.',
  insightListEmpty: '표시할 인사이트가 없습니다.',
  insightListEmptyWatchlist: '관심종목과 연결된 인사이트가 없습니다.',
  insightListError: '인사이트를 불러오지 못했습니다.',
  insightDatePickerTitle: '생성일 기준',
  insightDateToday: '오늘',
  insightDatePrevious: '이전 날짜',
  insightDateNext: '다음 날짜',
  insightOpenCalendar: '날짜 선택',
  insightWatchlistOnly: '관심종목만 {{count}}개',
  ...
  feedRefreshNoticeBoth: '오늘의 시그널과 새 뉴스 {{count}}개가 업데이트되었습니다.',
  feedRefreshNoticeInsight: '오늘의 시그널이 업데이트되었습니다.',
  ...
  symbolDetailQuantSection: '투자 관점',
  ...
  briefingMarketBriefingsTitle: '시장 브리핑',
  briefingHubEyebrow: 'Signal Market Brief',
  briefingHubTitle: '오늘 시장을 먼저 정리합니다',
  briefingHubSubtitle: '국내 3회, 미국 1회 자동화 브리핑을 한 화면에서 확인하세요.',
  briefingHubWaitingBadge: '대기 중',
  briefingHubOpenDetail: '전체 브리핑 보기',
  briefingHubOpenBrief: '보기',
  ...
  briefingHubTimelineTitle: '회차별 브리핑',
  briefingHubTimelineEmpty: '아직 이전 회차가 없습니다.',
  briefingHubTimelineWaiting: '자동화가 생성한 회차가 여기에 쌓입니다.',
  briefingHubWatchKicker: 'My Watch',
  briefingHubWatchTitle: '내 관심 체크',
  briefingMarketKr: '국내',
  briefingMarketUs: '미국',
  briefingSessionMorning: '아침',
  briefingSessionLunch: '점심',
  briefingSessionEvening: '저녁',
  briefingSessionOvernight: '밤사이',
  ...
  briefingOpenTodaySignal: '오늘의 시그널 보기',
  ...
  briefingFocusTitle: '오늘 체크포인트',
  briefingFocusSignal: '최우선',
  briefingFocusSignalHeadline: '{{symbol}} · {{score}}점',
  briefingFocusMover: '변동',
  briefingFocusMoverHeadline: '{{symbol}} {{move}}',
  briefingFocusMoverMeta: '관심종목 중 가장 큰 등락',
  briefingFocusEarnings: '실적',
  briefingFocusEarningsHeadline: '{{symbol}} {{date}}',
  briefingFocusMacro: '일정',
  ...
  briefingRowNewsCount: '최근 뉴스 {{count}}건',
  ...
  briefingScheduleSectionTitle: '이번 주 일정',
  briefingScheduleTabAll: '전체',
  briefingScheduleTabEarnings: '실적',
  briefingScheduleTabMacro: '경제',
  briefingScheduleKindEarning: '실적',
  briefingScheduleKindMacro: '경제',
  briefingScheduleMergedEmpty: '표시할 일정이 없습니다.',
  briefingMarketTabTape: '지수',
  briefingMarketTabMacro: '매크로',
