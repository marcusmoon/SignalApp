...
export const ko = {
  ...
  quantSubtitle: '코스피 시총 상위 20개 후보를 일봉 추세·모멘텀·과열도 팩터로 분석해 상위 10개를 보여줍니다.',
  quantEmpty: '분석할 일봉 데이터가 아직 없습니다.',
  quantError: '퀀트 분석을 불러오지 못했습니다.',
  ...
  quantActionBuy: '매수',
  quantActionAccumulate: '분할매수',
  quantActionHold: '관망',
  quantActionReduce: '비중축소',
  quantActionAvoid: '회피',
  quantFactorTrend: '추세',
  ...
  symbolDetailQuantSection: '가격 분석',
