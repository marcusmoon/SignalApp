...
export const ko = {
  ...
  settingsHomeBoardDisplayHint: '홈 게시판에서 출처별로 보여 줄 최근 글 수입니다.',
  settingsHomeBoardDisplayValue: '출처당 {{count}}개',
  ...
  disclosuresFocusAll: '전체',
  disclosuresFocusImportant: '중요',
  disclosuresImportantBadge: '중요',
  disclosuresEmpty: '표시할 공시가 없습니다.',
  disclosuresEmptyImportant: '중요한 공시가 없습니다.',
