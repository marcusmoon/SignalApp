 ...
 */
export const ko = {
  focusNewsTitle: '관심 대상의 변화',
  focusNewsTab: '관심 소식',
  focusNewsPeriod: '선택일 기준 최근 7일 · 최신순',
  focusNewsEmpty: '최근 7일에 확인된 관련 이슈가 없습니다.',
  focusNewsMore: '소식 더보기',
  newsRevisionCorrection: '정정된 내용',
  newsRevisionUpdate: '추가된 내용',
  newsRevisionFacts: '핵심 사실',
  newsPreviousUpdates: '이전 경과',
  newsHistoryRetry: '이전 경과 다시 불러오기',
  newsSave: '이 기기에 저장',
  newsUnsave: '저장 해제',
  newsSaveFailed: '저장하지 못했습니다.',
  newsSaved: '저장',
  newsSavedEmpty: '이 기기에 저장한 이슈가 없습니다.',
  companyTimeline: '최근 변화',
  companyTimelineRetry: '일부 소식을 불러오지 못했습니다. 다시 시도',
  companyUpcomingEarnings: '다가올 실적',
  companyBriefing: '시장 브리핑',
  homeNewsAll: '전체',
  homeNewsWatch: '관심종목',
  homeNewsRead: '읽음',
  homeNewsUnavailable: '정보를 불러오지 못했습니다.',
  homeNewsNoWatchlist: '등록한 관심종목이 없습니다.',
  homeNewsNoMatch: '이 날짜에 관심종목 소식이 없습니다.',
  homeNewsManageWatchlist: '관심종목 관리',
  homePartialLoadError: '{{sections}} 업데이트 실패. 마지막으로 불러온 정보는 유지됩니다.',
  homeReadBriefing: '브리핑 전문',
  commonBack: '뒤로',
  commonCancel: '취소',
  filterSheetDone: '완료',
  ...
  homeKeywordsTitle: '트렌드',
  /** 더보기·사이드바·홈 숏컷 짧은 라벨 (홈 섹션 제목은 homeEtfInsightTitle) */
  moreHubEtfShort: '섹터',
  digestFreshBadge: '최신',
  digestFreshBadgeA11y: '최근 갱신됨',
  digestCopyText: '복사',
  digestCopyTextA11y: '제목과 요약 복사',
  digestCopyDone: '복사됨',
  digestCopyFailed: '복사하지 못했습니다.',
  ...
  settingsHomeDisplayHint:
    '홈에 보이는 관심 종목·섹터·뉴스 개수를 조절합니다. 히어로·일정 칩은 자동입니다.',
  settingsHomeNewsFlowDisplaySection: '뉴스',
  settingsHomeNewsFlowDisplayHint: '홈에 표시할 뉴스 개수를 선택합니다.',
  ...
  settingsHomeSectorFlowDisplaySection: '섹터',
  settingsHomeSectorFlowDisplayHint: '홈 섹터 히트맵에 표시할 셀 개수를 선택합니다.',
  ...
  todayBriefingLoadError: '정리를 불러오지 못했습니다.',
  todayBriefingEmpty: '이 날짜의 정리가 없습니다.',
  todayBriefingDetailKicker: '정리',
  ipadHomeLoadError: '홈 정보를 불러오지 못했습니다.',
  homeFocusSourceCount: '출처 {{count}}개',
  homeFocusWatchTitle: '시세',
  homeFocusBoardSubtitle: '미주미 · 미치다 · 모틀리',
  homeFocusBoardEmpty: '최신 글이 없습니다',
  homeFocusSignalEmpty: '표시할 회차가 없습니다.',
  screenGameCenter: '게임',
  ...
  homeEtfInsightTitle: '섹터',
  homeEtfInsightEmpty: '이 날짜의 섹터가 없습니다.',
  etfInsightDetailKicker: '섹터',
  ...
  etfInsightLoadError: '섹터를 불러오지 못했습니다.',
  etfInsightEmpty: '표시할 섹터가 없습니다.',
  etfInsightListEmpty: '등록된 섹터가 없습니다.',
  newsIssuesTitle: '뉴스',
  newsIssuesCategoryAll: '전체',
  newsIssuesEmpty: '이 날짜에 표시할 뉴스가 없습니다.',
  newsIssuesLoadError: '뉴스를 불러오지 못했습니다.',
  newsDigestEmpty: '표시할 뉴스가 없습니다.',
  ...
  calendarScopeMeaningful: '주요',
  calendarScopeFull: '전체 지표',
  calendarSectionPolicy: '통화정책',
  calendarSectionMacro: '주요 지표',
  calendarSectionEarnings: '관심 실적',
  calendarSectionHoliday: '휴장',
  calendarScreenEmptyDayMeaningful: '이 날짜에 주요 일정이 없습니다.',
  calendarFilterEmptyMeaningful: '이 달에 주요 일정이 없습니다.',
  ...
  accountHubDisplaySettingsDesc:
    '화면 테마, 글자 크기, 탭 새 글 확인 간격, 홈 관심 종목·뉴스 개수를 조정합니다.',
  ...
  settingsFeedContentWeightHint:
    '홈(히어로·관심 종목·뉴스), 뉴스·시세 목록, 유튜브 카드의 글자 굵기와 행 여백에 적용됩니다.',
  ...
  settingsBriefingPushEnabledHint: '정리, 뉴스, 회차가 도착하면 알림함과 푸시로 받습니다.',
  ...
  alertsTypeTodayBriefing: '정리',
  alertsTypeMarketBriefing: '회차',
  ...
  feedDigestTailGoToNewsFlowA11y: '뉴스로 이동',
  ...
  quotesWatchReorderA11y: '{{symbol}} 길게 눌러 순서 바꾸기',
