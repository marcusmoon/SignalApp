...
export const ko = {
  ...
  settingsHomeDisplayHint:
    '홈에 보이는 관심 종목·섹터 흐름·뉴스 개수를 조절합니다. 히어로·일정은 자동입니다.',
  settingsHomeNewsFlowDisplaySection: '뉴스',
  settingsHomeNewsFlowDisplayHint: '홈 하단 뉴스에 표시할 개수를 선택합니다.',
  ...
  accountHubDisplaySettingsDesc: '화면 테마, 글자 크기, 홈 관심 종목·뉴스 개수를 조정합니다.',
