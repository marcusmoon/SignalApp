...
export const ko = {
  ...
  settingsHomeDisplaySection: '홈',
  settingsHomeDisplayHint:
    '홈에 보이는 바로가기·관심 종목·섹터 흐름·뉴스 흐름을 조절합니다. 히어로·일정 칩은 자동입니다.',
  ...
  settingsHomeShortcutsSection: '바로가기',
  settingsHomeShortcutsHint: '홈 중간 바로가기를 고릅니다. 최대 {{count}}개.',
