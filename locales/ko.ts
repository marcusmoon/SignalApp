...
export const ko = {
  ...
  ipadHomeSignalTitle: '시그널',
  ipadHomeSignalSubtitle: '시장 브리핑 요약',
  ...
  todayBriefingDisclosureDigestTitle: '주요 공시',
  todayBriefingDisclosureDigestSubtitle: '오늘 나온 핵심 공시',
  todayBriefingDisclosureDigestEmpty: '오늘 표시할 주요 공시가 없습니다.',
  todayBriefingReadMore: '전체 보기',
  todayBriefingKeyPoints: '핵심 포인트',
  todayBriefingSources: '출처',
  todayBriefingLoadError: '오늘의 브리핑을 불러오지 못했습니다.',
  todayBriefingEmpty: '이 날짜의 브리핑이 없습니다.',
  todayBriefingDetailKicker: '마감 브리핑',
  ipadHomeLoadError: '홈 정보를 불러오지 못했습니다.',
  homeFocusHeroKicker: '핵심 이슈',
  homeFocusSourceCount: '출처 {{count}}개',
  homeFocusWatchTitle: '관심 종목',
  homeFocusSignalTitle: '시그널',
  homeFocusSignalEmpty: '표시할 시그널이 없습니다.',
  newsIssuesTitle: '주요 이슈',
  newsIssuesEmpty: '이 날짜에 표시할 주요 이슈가 없습니다.',
  newsIssuesLoadError: '주요 이슈를 불러오지 못했습니다.',
  ...
  settingsBriefingPushEnabled: '시장 브리핑 푸시',
  settingsBriefingPushEnabledHint: '장전·장후·오버나잇 등 시장 브리핑이 도착하면 알림으로 받습니다.',
