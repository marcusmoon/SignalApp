...
export const ko = {
  ...
  accountSocialTitle: '간편 로그인 준비 중',
  ...
  accountTermsText: 'SIGNAL의 기본 이용약관과 개인정보 처리 안내에 동의합니다. 투자 정보는 참고용이며 투자 판단의 책임은 사용자에게 있습니다.',
  accountTermsRequired: '가입하려면 기본 약관 동의가 필요합니다.',
  ...
  settingsSignalAlertsEnabled: '오늘의 시그널 알림 후보',
  settingsSignalAlertsHint: 'Insight Job이 만든 푸시 후보를 알림 화면에서 먼저 확인합니다.',
  settingsSignalWatchlistOnly: '관심종목 시그널만',
  settingsSignalWatchlistOnlyHint: '내 관심종목과 연결된 시그널만 알림 후보로 봅니다.',
  ...
  alertsLoginRequiredButton: '계정으로 이동',
