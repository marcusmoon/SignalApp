...
export const ko = {
  ...
  homeEvidenceFallback: '관련 뉴스와 영상이 준비되면 여기에서 보여줍니다.',
  homeEvidenceNewsFallback: '최신 뉴스가 준비되면 여기에서 보여줍니다.',
  homeEvidenceYoutubeFallback: '관련 영상이 준비되면 여기에서 보여줍니다.',
  ...
  feedSegmentVideo: '영상',
  feedEmptyWatch: '관심종목과 연결된 최신 뉴스가 없습니다. 관심종목을 추가하거나 글로벌 뉴스를 확인해 주세요.',
  feedEmptyVideo: '표시할 영상이 없습니다. 유튜브 전체 화면을 확인하거나 잠시 후 다시 새로고침해 주세요.',
