...
export const ko = {
  ...
  settingsHomeVariantSection: '홈 화면 구성',
  settingsHomeVariantHint: '기존 홈 또는 핵심 정보 중심의 새 홈을 선택합니다.',
  settingsHomeVariantClassic: '기존',
  settingsHomeVariantFocus: '새 홈',
  settingsHomeWatchlistDisplaySection: '홈 관심 종목',
  settingsHomeWatchlistDisplayHint: '새 홈에 표시할 관심 종목 수를 선택합니다.',
