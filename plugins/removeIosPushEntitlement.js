 ...
 *
 * 원격 푸시(APNs)가 필요한 TestFlight/App Store 빌드는 Apple Developer Program(유료) 가입 후
 * SIGNAL_IOS_REMOTE_PUSH_ENABLED=1로 app.config.js가 이 플러그인을 제외하게 한 뒤 prebuild/rebuild합니다.
 */
const fs = require('fs');
