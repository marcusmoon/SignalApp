...
function publicYoutube(item) {
  return {
    ...
    channelSubscriberCount: Number(item.channelSubscriberCount) || 0,
    channelVideoCount: Number(item.channelVideoCount) || 0,
    channelViewCount: Number(item.channelViewCount) || 0,
