      ...
      '/v1/news': {
        get: {
          ...
          parameters: [
            ...
            { name: 'source', in: 'query', schema: { type: 'string', example: 'Financial Juice' } },
            { name: 'sources', in: 'query', schema: { type: 'string', example: 'Financial Juice,Bloomberg' } },
            { name: 'flash', in: 'query', schema: { type: 'boolean', description: 'Filter to breaking/flash news candidates' } },
